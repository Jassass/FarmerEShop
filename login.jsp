				...
				<form class="col s12" action="login.jsp" method="POST">
					<fieldset style="color:#12ef0e">
						...
						<div class="input-field col s12">
							<i class="material-icons prefix">phone</i> <input name="contactNumber" id="contact" type="number" class="validate"
								value='<c:out value="${param.contactNumber}" />'>
							<label for="contact">Contact Number</label>
						</div>
						<div class="input-field col s12">
							<i class="material-icons prefix">check</i> <input name="password" id="password" type="password" class="validate">							<label for="password">Password</label>
						</div>
						<div class="col s12">
							<div class="col s1"></div>
							<button class="btn waves-effect waves-light col s3" type="submit" name="login" value="true">
							LOGIN <i class="material-icons right">send</i>
						</button>
							<div class="col s1"></div>
							<a href="signup.jsp" class="btn waves-effect waves-light col s6" name="action">
