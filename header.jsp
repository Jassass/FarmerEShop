<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<%@taglib prefix="sql" uri="http://java.sun.com/jsp/jstl/sql" %>
		<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			<sql:setDataSource scope="application" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost/farmereshop" user="root"
				password="" />
				...
				<div class="row">
					...
					<div class="col s3">
						<ul id="slide-out" class="side-nav fixed">
							<li>
								<div class="light-green accent-3 user-view">
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<li id="acceptedItems"><a href="acceptedItems.jsp" class="waves-effect">Items Status</a></li>
								</c:otherwise>
							</c:choose>
